...
part 'highCourtApiClient.g.dart';

@RestApi(baseUrl: AppConstants.HcUrl)
abstract class HighCourtApiClient {
  factory HighCourtApiClient(Dio dio, {String? baseUrl}) = _HighCourtApiClient;

  @GET('HighCourtService/GetDetailByCNR/SearchByCnr')
  Future<GetDetailByCnrModel> getDetailByCNR(@Query("CinNo") String CinNo);

  @GET('HighCourtService/GetDetailCaseType/CaseTypeMaster')
  Future<CaseTypeResponse> getDetailCaseType(@Query("EstCode") String EstCode);

  @POST('HighCourtService/GetDetailByCaseNumber/SearchByCaseNumber')
...
class HighCourtApiServiceApiclient {
  static Future<HighCourtApiClient> createService(BuildContext context) async {
    final dio = Dio();
